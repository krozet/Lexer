...
public class TokenType {
    ...
    public TokenType() {
        ...
        tokens.put(Tokens.Double, Symbol.symbol("double", Tokens.Double));
        ...
        tokens.put(Tokens.DoubleOr, Symbol.symbol("||", Tokens.DoubleOr));
        tokens.put(Tokens.And, Symbol.symbol("&", Tokens.And));
        tokens.put(Tokens.DoubleAnd, Symbol.symbol("&&", Tokens.DoubleAnd));
    ...
    public boolean isToken(Tokens key)
    {
